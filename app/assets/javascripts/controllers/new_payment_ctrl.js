angular.module("szama").controller("NewPaymentCtrl", function($scope, $location, Payment, TempPayments, User) {
  ...
  $scope.addNewPayment = function() {
    ...
    $scope.newPayment.id = $scope.payments.length + 1;
    // Push new payment
    $scope.payments.push($scope.newPayment);
    TempPayments.setData($scope.payments);
